package com.xiaomi.misettings.display.appname;
...
public final class AppNameManagerDatabase_Impl extends AppNameManagerDatabase {
    ...
    @Override // com.xiaomi.misettings.display.appname.AppNameManagerDatabase
    public b s() {
        b bVar;
        if (this.f9518l != null) {
            return this.f9518l;
    ...
    class a extends i.a {
        ...
        protected i.b g(m0.b bVar) {
            ...
            if (!fVar.equals(a10)) {
                return new i.b(false, "app_name(com.xiaomi.misettings.display.appname.AppNameEntry).\n Expected:\n" + fVar + "\n Found:\n" + a10);
            }
