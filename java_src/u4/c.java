...
public final class c {
    ...
    public static final int BorderLayout_checkedBackGround = 0;
    public static final int BubbleLayout_bubbleBackgroundColor = 0;
    public static final int BubbleLayout_bubbleRadius = 1;
    public static final int BubbleLayout_triangleOffset = 2;
    ...
    public static final int CircularProgressView_progEndColor = 3;
    ...
    public static final int FloatingActionButton_fabShadowColor = 1;
    public static final int FloatingActionButton_fabShadowEnabled = 2;
    public static final int FlowLayout_itemSpacing = 0;
    public static final int FlowLayout_lineGravity = 1;
    ...
    public static final int LimitSizeTextView_limitFontScale = 0;
    ...
    public static final int MiuiDefaultRingtoneItem_layout = 0;
    ...
    public static final int NestedHeaderLayout_headerAutoClose = 0;
    public static final int NestedHeaderLayout_headerContentId = 1;
    public static final int NestedHeaderLayout_headerContentMinHeight = 2;
    public static final int NestedHeaderLayout_headerView = 3;
    public static final int NestedHeaderLayout_maskBackground = 4;
    public static final int NestedHeaderLayout_rangeOffset = 5;
    public static final int NestedHeaderLayout_stickyBeyondTrigger = 6;
    public static final int NestedHeaderLayout_stickyView = 7;
    public static final int NestedHeaderLayout_triggerContentId = 8;
    public static final int NestedHeaderLayout_triggerContentMinHeight = 9;
    public static final int NestedHeaderLayout_triggerView = 10;
    public static final int NestedScrollingLayout_headerClose = 0;
    public static final int NestedScrollingLayout_overScrollTo = 1;
    public static final int NestedScrollingLayout_overScrollToRatio = 2;
    public static final int NestedScrollingLayout_scrollType = 3;
    public static final int NestedScrollingLayout_scrollableView = 4;
    public static final int NestedScrollingLayout_selfScrollFirst = 5;
    ...
    public static final int ResponsiveActionMenuView_suspendMenuBackground = 1;
    ...
    public static final int SpecialFeature_specialIcon = 0;
    public static final int SpecialFeature_specialSummary = 1;
    public static final int SpecialFeature_specialTitle = 2;
    ...
    public static final int StateTransitionDrawable_hoveredActivatedAlpha = 1;
    public static final int StateTransitionDrawable_hoveredAlpha = 2;
    public static final int StateTransitionDrawable_normalAlpha = 3;
    public static final int StateTransitionDrawable_pressedAlpha = 4;
    public static final int StateTransitionDrawable_tintColor = 5;
    public static final int StateTransitionDrawable_tintRadius = 6;
    ...
    public static final int VisualCheckGroup_checkedButton = 0;
    ...
    public static final int Window_immersionTextColor = 7;
    public static final int Window_immersionViewItemBackground = 8;
    public static final int Window_immersionWindowBackground = 9;
    public static final int Window_isMiuixFloatingTheme = 10;
    public static final int Window_responsiveEnabled = 11;
    public static final int Window_startingWindowOverlay = 12;
    public static final int Window_windowActionBar = 13;
    public static final int Window_windowActionBarMovable = 14;
    public static final int Window_windowActionBarOverlay = 15;
    public static final int Window_windowDisablePreview = 16;
    public static final int Window_windowExtraPaddingApplyToContentEnable = 17;
    public static final int Window_windowExtraPaddingHorizontal = 18;
    public static final int Window_windowExtraPaddingHorizontalEnable = 19;
    public static final int Window_windowFixedHeightMajor = 20;
    public static final int Window_windowFixedHeightMinor = 21;
    public static final int Window_windowFixedWidthMajor = 22;
    public static final int Window_windowFixedWidthMinor = 23;
    public static final int Window_windowFloating = 24;
    public static final int Window_windowLayoutMode = 25;
    public static final int Window_windowMaxHeightMajor = 26;
    public static final int Window_windowMaxHeightMinor = 27;
    public static final int Window_windowMaxWidthMajor = 28;
    public static final int Window_windowMaxWidthMinor = 29;
    public static final int Window_windowSplitActionBar = 30;
    public static final int Window_windowTranslucentStatus = 31;
    ...
    public static final int[] ActionBar = {16842754, 16842964, 16843040, 16843049, 16843072, 16843093, 16843233, 16843454, 16843471, 16843472, 16843473, 16843474, 16843512, 16843513, 16843545, 16843549, 16843565, 16843658, 16843659, R.attr.actionBarEmbededTabsBackground, R.attr.actionBarStackedBackground, R.attr.background, R.attr.backgroundSplit, R.attr.backgroundStacked, R.attr.contentInsetEnd, R.attr.contentInsetEndWithActions, R.attr.contentInsetLeft, R.attr.contentInsetRight, R.attr.contentInsetStart, R.attr.contentInsetStartWithNavigation, R.attr.customNavigationLayout, R.attr.customViewAutoFitSystemWindow, R.attr.displayOptions, R.attr.divider, R.attr.elevation, R.attr.expandState, R.attr.expandSubtitleTextStyle, R.attr.expandTitleTextStyle, R.attr.height, R.attr.hideOnContentScroll, R.attr.homeAsUpIndicator, R.attr.homeLayout, R.attr.icon, R.attr.indeterminateProgressStyle, R.attr.itemPadding, R.attr.logo, R.attr.navigationMode, R.attr.navigatorSwitchIndicator, R.attr.navigatorSwitchLayout, R.attr.popupTheme, R.attr.progressBarPadding, R.attr.progressBarStyle, R.attr.resizable, R.attr.showOptionIcons, R.attr.subtitle, R.attr.subtitleTextStyle, R.attr.tabIndicator, R.attr.title, R.attr.titleCenter, R.attr.titleClickable, R.attr.titleTextStyle, R.attr.translucentTabIndicator};
    ...
    public static final int[] ActionMode = {16842964, 16843072, 16843093, 16843512, 16843513, 16843659, R.attr.actionModeAnim, R.attr.background, R.attr.backgroundSplit, R.attr.closeItemLayout, R.attr.expandTitleTextStyle, R.attr.height, R.attr.subtitleTextStyle, R.attr.titleTextStyle};
    ...
    public static final int[] AdaptRoundButtonDrawable = {R.attr.buttonCapsuleRadius, R.attr.buttonRadius};
    ...
    public static final int[] BubbleLayout = {R.attr.bubbleBackgroundColor, R.attr.bubbleRadius, R.attr.triangleOffset};
    ...
    public static final int[] CircularProgressView = {R.attr.backColor, R.attr.backWidth, R.attr.progColor, R.attr.progEndColor, R.attr.progStartColor, R.attr.progWidth, R.attr.progress};
    ...
    public static final int[] FilterSortTabView2 = {16843087, R.attr.arrowFilterSortTabView, R.attr.descending, R.attr.filterSortTabViewBackground, R.attr.filterSortTabViewForeground, R.attr.filterSortTabViewHorizontalPadding, R.attr.filterSortTabViewTabActivatedTextAppearance, R.attr.filterSortTabViewTabTextAppearance, R.attr.filterSortTabViewVerticalPadding, R.attr.indicatorVisibility};
    public static final int[] FilterSortView = {16842766, R.attr.filterSortTabViewCoverBg, R.attr.filterSortTabViewCoverBgInBlur, R.attr.filterSortTabViewFollowTouch, R.attr.filterSortViewBackground};
    public static final int[] FilterSortView2 = {16842766, R.attr.filterSortViewBackground, R.attr.layoutConfig};
    public static final int[] FloatingActionButton = {R.attr.fabColor, R.attr.fabShadowColor, R.attr.fabShadowEnabled};
    ...
    public static final int[] GroupButton = {R.attr.primaryButton};
    ...
    public static final int[] LimitSizeTextView = {R.attr.limitFontScale};
    ...
    public static final int[] MiuiDefaultRingtoneItem = {R.attr.layout};
    ...
    public static final int[] MiuixSmoothContainerDrawable = {16843176, 16843177, 16843178, 16843179, 16843180, 16843604, R.attr.miuix_strokeColor, R.attr.miuix_strokeWidth, R.attr.miuix_useSmooth};
    public static final int[] MiuixSmoothContainerDrawable2 = {16843176, 16843177, 16843178, 16843179, 16843180, 16843604, R.attr.miuix_solidColor, R.attr.miuix_strokeColor, R.attr.miuix_strokeWidth, R.attr.miuix_useSmooth};
    ...
    public static final int[] MiuixSmoothFrameLayout2 = {16843176, 16843177, 16843178, 16843179, 16843180, 16843604, R.attr.miuix_solidColor, R.attr.miuix_strokeColor, R.attr.miuix_strokeWidth, R.attr.miuix_useSmooth};
    public static final int[] MiuixSmoothGradientDrawable = {16843604, R.attr.miuix_solidColor, R.attr.miuix_strokeColor, R.attr.miuix_strokeWidth, R.attr.miuix_useSmooth};
    ...
    public static final int[] NestedHeaderLayout = {R.attr.headerAutoClose, R.attr.headerContentId, R.attr.headerContentMinHeight, R.attr.headerView, R.attr.maskBackground, R.attr.rangeOffset, R.attr.stickyBeyondTrigger, R.attr.stickyView, R.attr.triggerContentId, R.attr.triggerContentMinHeight, R.attr.triggerView};
    public static final int[] NestedScrollingLayout = {R.attr.headerClose, R.attr.overScrollTo, R.attr.overScrollToRatio, R.attr.scrollType, R.attr.scrollableView, R.attr.selfScrollFirst};
    ...
    public static final int[] OverflowMenuButton = {16843087, 16843117, 16843379};
    ...
    public static final int[] PreferenceCategory = {16843233, R.attr.needDividerLine};
    ...
    public static final int[] ResponsiveActionMenuView = {R.attr.bottomMenuBackground, R.attr.suspendMenuBackground};
    public static final int[] ResponsiveSpec = {16842960, R.attr.effectiveScreenOrientation, R.attr.hideInScreenMode};
    ...
    public static final int[] SpecialFeature = {R.attr.specialIcon, R.attr.specialSummary, R.attr.specialTitle};
    ...
    public static final int[] SpringInterpolator = {R.attr.springDamping, R.attr.springResponse};
    ...
    public static final int[] StateTransitionDrawable = {R.attr.activatedAlpha, R.attr.hoveredActivatedAlpha, R.attr.hoveredAlpha, R.attr.normalAlpha, R.attr.pressedAlpha, R.attr.tintColor, R.attr.tintRadius};
    ...
    public static final int[] Window = {R.attr.contentAutoFitSystemWindow, R.attr.contentHeaderBackground, R.attr.contextMenuSeparateItemBackground, R.attr.endActionMenuEnabled, R.attr.immersionButtonMoreBackground, R.attr.immersionMenuEnabled, R.attr.immersionMenuLayout, R.attr.immersionTextColor, R.attr.immersionViewItemBackground, R.attr.immersionWindowBackground, R.attr.isMiuixFloatingTheme, R.attr.responsiveEnabled, R.attr.startingWindowOverlay, R.attr.windowActionBar, R.attr.windowActionBarMovable, R.attr.windowActionBarOverlay, R.attr.windowDisablePreview, R.attr.windowExtraPaddingApplyToContentEnable, R.attr.windowExtraPaddingHorizontal, R.attr.windowExtraPaddingHorizontalEnable, R.attr.windowFixedHeightMajor, R.attr.windowFixedHeightMinor, R.attr.windowFixedWidthMajor, R.attr.windowFixedWidthMinor, R.attr.windowFloating, R.attr.windowLayoutMode, R.attr.windowMaxHeightMajor, R.attr.windowMaxHeightMinor, R.attr.windowMaxWidthMajor, R.attr.windowMaxWidthMinor, R.attr.windowSplitActionBar, R.attr.windowTranslucentStatus};
