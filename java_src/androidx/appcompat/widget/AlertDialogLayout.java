    ...
    private boolean y(int i10, int i11) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == c.f.topPanel) {
                    view = childAt;
                } else if (id == c.f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != c.f.contentPanel && id != c.f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = androidx.core.view.ViewCompat.w(r17)
            int r2 = androidx.core.view.s.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L97
            r3 = 5
