...
public class ActivityCompat extends ContextCompat {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(String[] strArr, Activity activity, int i10) {
    ...
    static class Api30Impl {
        ...
        @DoNotInline
        static void setLocusContext(@NonNull Activity activity, @Nullable androidx.core.content.f fVar, @Nullable Bundle bundle) {
            LocusId b10;
            if (fVar == null) {
                b10 = null;
            } else {
            ...
            activity.setLocusContext(b10, bundle);
        }
    }
    ...
    @Nullable
    public static androidx.core.view.q requestDragAndDropPermissions(@NonNull Activity activity, @NonNull DragEvent dragEvent) {
        return androidx.core.view.q.a(activity, dragEvent);
    }
    ...
    public static void requestPermissions(@NonNull Activity activity, @NonNull String[] strArr, @IntRange(from = 0) int i10) {
        ...
        for (int i11 = 0; i11 < strArr.length; i11++) {
            if (!TextUtils.isEmpty(strArr[i11])) {
                if (!BuildCompat.d() && TextUtils.equals(strArr[i11], "android.permission.POST_NOTIFICATIONS")) {
    ...
    public static void setLocusContext(@NonNull Activity activity, @Nullable androidx.core.content.f fVar, @Nullable Bundle bundle) {
        if (Build.VERSION.SDK_INT >= 30) {
            Api30Impl.setLocusContext(activity, fVar, bundle);
        }
    }
